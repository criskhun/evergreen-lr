...
<title>Latest Billing Statement Upload</title>
...
<div align="center">
<br />
Ulpoad Copy of Latest Billing Statemant <br />

	<form  action="savebillingstat.php"method="post" enctype="multipart/form-data" id="signupForm"/>
