...
<title>Overall Total Sales Report <?php echo $_GET['status']; ?></title>
...
<h1>Overall Total Sales Report <br><br>Sales Report <?php echo $_GET['SUM(price)']; ?></h1>
</div>
<table width="860" border="0" bordercolor="#354c07" align="center">
                            <tr>
                              <td width="200" align="center" bgcolor="#a5bc67">Owner</td>
                              ...
                              <td width="100" align="center" bgcolor="#a5bc67">Lot Number</td>
...
$status=$_GET['status'];
// sending query
$result = mysql_query("SELECT * FROM lot where lotstatus='$status' ORDER BY soldto ASC");
if (!$result) 
	{
...
If ($rows == 0) 
	...
	while ($i<$rows)
		{		
			...
			$owner = MYSQL_RESULT($result,$i,"soldto");
