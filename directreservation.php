...
<table width="586">
	...
	<td width="404" align="left"><input name="buyer" id="buyer" class="inputclass pageRequired" title="Buyer Name is Required" maxlength="254" onblur="recordClientAddress1.value = this.value" style="text-transform:capitalize"/></td>
	<tr>
...
<td width="404" align="left"><input name="email" id="email" class="inputclass pageRequired" maxlength="254" title="Email address is required" /></td>
</tr>
<tr>
<td align="left"><div class="txt">Password:<font color="#FF0000">*</font></div></td>
<td align="left"><input type="password" name="password" id="password" class="inputclass pageRequired"  maxlength="6" title="Enter Password" /></td>
</tr>
	<tr>
